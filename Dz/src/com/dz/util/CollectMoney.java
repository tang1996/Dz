...
public class CollectMoney {
	private static String partner = "1507027841";// 微信支付商户号
	private static String partnerkey = "guangdongshengshenzhengshidongzi";// 财付通初始密�?
	...
	final static String KEYSTORE_FILE = "c:\\apiclient_cert.p12";
	final static String KEYSTORE_PASSWORD = "1507027841";
	...
	public static String doSendMoney(String url, String data) throws Exception {
		...
		//InputStream instream = MoneyUtils.class.getResourceAsStream("./cert/apiclient_cert.p12");
        try {
