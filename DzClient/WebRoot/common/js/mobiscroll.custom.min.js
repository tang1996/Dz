...
(function (h, f) {
    ...
    var d, e = +new Date(), a = {}, m = h.extend, n = document.createElement("modernizr").style,
        k = j(["perspectiveProperty", "WebkitPerspective", "MozPerspective", "OPerspective", "msPerspective"]),
        c = j(["flex", "msFlex", "WebkitBoxDirection"]), i = g(),
    ...
    d = h.mobiscroll = h.mobiscroll || {
        ...
        util: {
            ...
            getCoord: function (r, t, q) {
                var p = r.originalEvent || r, s = (q ? "page" : "client") + t;
            ...
            addIcon: function (s, p) {
                var q = {}, u = s.parent(), t = u.find(".mbsc-err-msg"), v = s.attr("data-icon-align") || "left",
                    r = s.attr("data-icon");
        ...
        classes: {},
        components: {},
        defaults: {context: "body", mousewheel: true, vibrate: true},
        setDefaults: function (p) {
            m(this.defaults, p)
        },
        presetShort: function (q, s, r) {
            this.components[q] = function (p) {
                return o(this, m(p, {component: s, preset: r === false ? f : q}), arguments)
            }
        }
    };
...
(function (i, n, o, h) {
    var e, m, c = i.mobiscroll, j = c.util, b = j.jsPrefix, l = j.has3d, p = j.constrain, d = j.isString,
        q = j.isOldAndroid, a = /(iphone|ipod|ipad).* os 8_/i.test(navigator.userAgent),
        f = "webkitAnimationEnd animationend", k = function () {
        }, g = function (r) {
            r.preventDefault()
        };
    c.classes.Frame = function (ae, af, B) {
        var M, y, z, ab, W, H, x, r, A, L, P, Z, ai, E, X, K, O, R, ag, aa, C, w, ah, t, V = this, U = i(ae), G = [],
            Q = {};
        ...
        V.position = function (aG) {
            var ar, aA, av, ao, au, aD, ay, ax, aB, aj, aC, s, aE, ak, aF, az, aJ = 0, an = 0, aq = {},
                aI = Math.min(r[0].innerWidth || r.innerWidth(), H.width()), am = r[0].innerHeight || r.innerHeight(),
        ...
        V.attachShow = function (s, aj) {
            G.push({readOnly: s.prop("readonly"), el: s});
            ...
            ab.on("selectstart mousedown", g).on("click", ".dwb-e", g).on("keydown", ".dwb-e", function (al) {
                ...
                if (ao.keyCode == 32) {
                    ...
                    if (ao.keyCode == 9 && X && aa.focusTrap) {
                        ...
                        }), al = an.index(i(":focus", ab)), am = an.length - 1, ap = 0;
                        if (ao.shiftKey) {
                            am = 0;
                            ap = -1
                        }
        ...
        V.init = function (s) {
            ...
            V.buttons.set = {text: aa.setText, handler: "set"};
            V.buttons.cancel = {text: (V.live) ? aa.closeText : aa.cancelText, handler: "cancel"};
            V.buttons.clear = {text: aa.clearText, handler: "clear"};
...
(function (h, k, l, f) {
    var c = h.mobiscroll, g = c.classes, i = c.util, b = i.jsPrefix, j = i.has3d, a = i.hasFlex, d = i.getCoord,
        m = i.constrain, e = i.testTouch;
    c.presetShort("scroller", "Scroller", false);
    g.Scroller = function (aj, al, F) {
        var ai, W, ad, am, Z, z, ae, D, R, aa, r, O, v, I, ag, an, M, o, T, X, Q, ac = this, ab = h(aj), P = {}, S = {},
            C = [];
        ...
        function ah(au) {
            if (o) {
                var ap = new Date() - v, ax = m(Math.round(ag + (O - I) / am), an - 1, M + 1), ao = ax, aq, at,
                    ar = o.offset().top;
                au.stopPropagation();
                if (au.type === "mouseup") {
                ...
                if (!r) {
                    var av = Math.floor((I - ar) / am), aw = h(h(".dw-li", o)[av]), p = aw.hasClass("dw-v"), s = ad;
                    ap = 0.1;
        ...
        function B(s) {
            if (!G(this)) {
                s.preventDefault();
                s = s.originalEvent || s;
                var ao = s.deltaY || s.wheelDelta || s.detail, p = h(".dw-ul", this);
                t(p);
        ...
        function J(aq) {
            var ap = '<div class="dw-bf">', s = C[aq], p = 1, at = s.labels || [], ao = s.values || [],
                ar = s.keys || ao;
        ...
        function ak(aq, s, ao, p, ap) {
            if (R("validate", [ai, s, aq, p]) !== false) {
                h(".dw-ul", ai).each(function (av) {
                    var au = h(this), ar = au.closest(".dwwl").hasClass("dwwms"), ax = av == s || s === f,
                        at = U(ac._tempWheelArray[av], au, p, ar, true), aw = at.selected;
                    if (!aw || ax) {
...
(function (b, c) {
    ...
    a.datetime = {
        defaults: {
            ...
            var k = b.extend({}, a.datetime.defaults, x), j = k.defaultValue || new Date();
            if (!v || !n) {
                return j
            }
            if (n.getTime) {
            ...
            var d = k.shortYearCutoff, f = k.getYear(j), z = k.getMonth(j) + 1, t = k.getDay(j), i = -1,
                w = j.getHours(), o = j.getMinutes(), g = 0, l = -1, r = false, m = function (s) {
                    ...
                    var C = (B == "@" ? 14 : (B == "!" ? 20 : (B == "y" ? 4 : (B == "o" ? 3 : 2)))),
                        D = new RegExp("^\\d{1," + C + "}"), s = n.substr(u).match(D);
                    if (!s) {
                        return 0
                    }
                    u += s[0].length;
...
(function (d, f) {
    var b = d.mobiscroll, g = b.datetime, a = new Date(), e = {
        ...
        if (U.is("input")) {
            ...
            var aE = U.attr("min"), w = U.attr("max");
            if (aE) {
        ...
        var X, W, P, B, q, v, Y, ae, j, ak, am = d.extend({}, h.settings),
            Q = d.extend(h.settings, b.datetime.defaults, e, av, am), r = 0, aA = [], E = [], ab = [], T = {}, D = {},
            Z = {y: M, m: an, d: ad, h: L, i: aq, s: H, u: m, a: A}, at = Q.invalid, G = Q.valid, S = Q.preset,
            l = Q.dateOrder, ac = Q.timeWheels, aD = l.match(/D/), I = ac.match(/a/i), ap = ac.match(/h/),
            ai = S == "datetime" ? Q.dateFormat + Q.separator + Q.timeFormat : S == "time" ? Q.timeFormat : Q.dateFormat,
            J = new Date(), R = Q.steps || {}, aj = R.hour || Q.stepHour || 1, ag = R.minute || Q.stepMinute || 1,
            af = R.second || Q.stepSecond || 1, ay = R.zeroBased, t = Q.minDate || new Date(Q.startYear, 0, 1),
            au = Q.maxDate || new Date(Q.endYear, 11, 31, 23, 59, 59), F = ay ? 0 : t.getHours() % aj,
            C = ay ? 0 : t.getMinutes() % ag, y = ay ? 0 : t.getSeconds() % af, aC = z(aj, F, (ap ? 11 : 23)),
            az = z(ag, C, 59), ax = z(ag, C, 59);
        u = u || ai;
        if (S.match(/date/i)) {
        ...
        function x(p, o, i, s) {
            p.push({values: i, keys: o, label: s})
        }
        ...
        function aB(s) {
            ...
            var o = ao(s, "y"), p = ao(s, "m"), k = Math.min(ao(s, "d"), Q.getMaxDayOfMonth(o, p)), i = ao(s, "h", 0);
        ...
        function aw(k, aX, aK, a3, aI, aR, a4, a7, aO) {
            var a5, aT, aQ, a2, a1, aN, aL, s, o, aU, aS, aP, aM, a6, p, a0, aZ, aW, aH = {},
                aY = {h: aj, i: ag, s: af, a: 1}, aV = Q.getDate(aI, aR, a4), aJ = ["a", "h", "i", "s"];
            if (k) {
        ...
        h.buttons.now = {text: Q.nowText, handler: "now"};
        at = N(at);
        G = N(G);
        j = {y: t.getFullYear(), m: 0, d: 1, h: F, i: C, s: y, a: 0};
        ak = {y: au.getFullYear(), m: 11, d: 31, h: aC, i: az, s: ax, a: 1};
        return {
            wheels: E, headerText: Q.headerText ? function () {
                return g.formatDate(ai, aB(h.getArrayVal(true)), Q)
            } : false, formatValue: function (i) {
                ...
                var o = al(aB(h.getArrayVal(true)), s), aM = aG(o), aK = ao(aM, "y"), aH = ao(aM, "m"), aL = true,
                    aJ = true;
                d.each(["y", "m", "d", "a", "h", "i", "s"], function (aV, aS) {
                    if (T[aS] !== f) {
                        var aR = j[aS], aU = ak[aS], aQ = 31, aN = ao(aM, aS), aX = d(".dw-ul", k).eq(T[aS]);
                        if (aS == "d") {
                            aQ = Q.getMaxDayOfMonth(aK, aH);
                            aU = aQ;
                            if (aD) {
                                d(".dw-li", aX).each(function () {
                                    var aY = d(this), a0 = aY.data("val"), i = Q.getDate(aK, aH, a0).getDay(),
                        ...
                        if (aS == "d") {
                            var aT = Q.getDate(aK, aH, 1).getDay(), aW = {};
                ...
                if (ae) {
                    d.each(["a", "h", "i", "s"], function (aP, aN) {
                        var aR = ao(aM, aN), aQ = ao(aM, "d"), aO = d(".dw-ul", k).eq(T[aN]);
                        if (T[aN] !== f) {
...
(function (d, f) {
    var c = d.mobiscroll, b = c.util, a = b.isString, e = {
        batch: 40,
        inputClass: "",
        invalid: [],
        rtl: false,
    ...
    c.presets.scroller.select = function (M) {
        var j, v, A, L, D, h, O, af, k, t, q, U, H, aj, J, l = {}, ah = {}, C = {}, w = {}, ae = {},
            g = d.extend({}, M.settings), W = d.extend(M.settings, e, g), m = W.batch,
            K = W.layout || (/top|bottom/.test(W.display) ? "liquid" : ""), G = K == "liquid", ag = d(this),
            Q = W.multiple || ag.prop("multiple"), P = b.isNumeric(W.multiple) ? W.multiple : Infinity,
            S = this.id + "_dummy", y = d('label[for="' + this.id + '"]').attr("for", S),
            Z = W.label !== f ? W.label : (y.length ? y.text() : ag.attr("name")),
            u = "dw-msel mbsc-ic mbsc-ic-" + W.checkIcon, Y = W.readonly, ai = W.data, R = !!ai,
            ad = R ? !!W.group : d("optgroup", ag).length, T = W.group, aa = ad && T && T.groupWheel !== false,
            ac = ad && T && aa && T.clustered === true, B = ad && (!T || (T.header !== false && !ac)),
            ak = ag.val() || [], V = [], I = {}, E = {}, o = {};
        ...
        function N() {
            ...
            if (R) {
                d.each(W.data, function (at, ar) {
                    ...
                    ap = ar[W.dataValue];
                    ao = ar[W.dataGroup];
                    an = {value: ap, text: i, index: at};
                    E[ap] = an;
                    t.push(an);
                    if (ad) {
                        if (al[ao] === f) {
                            am = {text: ao, value: aq, options: [], index: aq};
                            o[aq] = am;
                            al[ao] = aq;
                            L.push(am);
                            aq++
                ...
                if (ad) {
                    d("optgroup", ag).each(function (ar) {
                        o[ar] = {text: this.label, value: ar, options: [], index: ar};
                        L.push(o[ar]);
                        d("option", this).each(function (at) {
                            an = {value: this.value, text: this.text, index: ac ? at : s++, group: ar};
                            E[this.value] = an;
                            t.push(an);
                    ...
                    d("option", ag).each(function (ar) {
                        an = {value: this.value, text: this.text, index: ar};
                        E[this.value] = an;
                        t.push(an);
                        if (this.disabled) {
                            V.push(this.value)
            ...
            if (B) {
                ...
                d.each(o, function (at, ar) {
                    ap = "__group" + at;
                    an = {text: ar.text, value: ap, group: at, index: s++};
                    E[ap] = an;
                    t.push(an);
                    V.push(an.value);
        ...
        function F(av, an, ar, au, ap, ay, at) {
            var ao, aq, ax = [], aw = [], al = ar[au] !== f ? ar[au].index : 0, s = Math.max(0, al - m),
            ...
            if (ah[ap] !== s || C[ap] !== am) {
                ...
                w[ap] = s;
                ae[ap] = am;
                aq = {multiple: ay, values: aw, keys: ax, label: at};
                if (G) {
                    av[0][ap] = aq
                } else {
                    av[ap] = [aq]
        ...
        function n(i) {
            var al = i.attr("data-val"), s = i.hasClass("dw-msel");
        ...
        return {
            ...
            validate: function (al, aq, am, an) {
                var ao, av, au = [], aw = M.getArrayVal(true), s = aw[O], ap = aw[q], at = d(".dw-ul", al).eq(O),
                    ar = d(".dw-ul", al).eq(q);
                if (ah[O] > 1) {
...
(function (b) {
    var a = b.mobiscroll.themes.frame, c = {
        display: "bottom",
        dateOrder: "MMdyy",
        rows: 7,
        height: 29,
